...
namespace FreelanceForAll.Tests
{
    public abstract class FreelanceForAllTestBase : AbpIntegratedTestBase
    {
        protected FreelanceForAllTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<FreelanceForAllApplicationModule>();
            modules.Add<FreelanceForAllDataModule>();
        }

        public void UsingDbContext(Action<FreelanceForAllDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<FreelanceForAllDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<FreelanceForAllDbContext, T> func)
        {
            T result;
